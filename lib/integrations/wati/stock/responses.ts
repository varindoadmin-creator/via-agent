...
export function needQuantityPrompt(): string {
  return 'Baik Kak, boleh diinformasikan berapa lembar yang dibutuhkan? Kami bantu cek ketersediaannya.';
}

export function existenceAvailable(): string {
  return 'Baik Kak, untuk barang tersebut saat ini tersedia.';
}

export function existenceOutOfStock(): string {
  return 'Mohon maaf Kak, untuk barang tersebut saat ini stok belum tersedia.';
}
...
export function sufficientForRequest(requestedQuantity: number, requestedUnit: string | null): string {
  ...
  return `Baik Kak, untuk kebutuhan ${requestedQuantity} ${unit} saat ini tersedia.`;
}
...
export function sufficientViaFallback(requestedQuantity: number, requestedUnit: string | null): string {
  const unit = requestedUnit || 'unit';
  return `Baik Kak, untuk kebutuhan ${requestedQuantity} ${unit} saat ini masih dapat kami penuhi.`;
}

export function insufficientForRequest(): string {
  return 'Mohon maaf Kak, untuk kebutuhan tersebut saat ini belum dapat kami penuhi.';
}
...
export function vendorClosedAck(): string {
  return 'Baik Kak, kami akan segera cek ketersediaannya dan menginformasikan kembali secepatnya.';
}

export function unknownNeedsFollowUp(): string {
  return 'Mohon maaf Kak, kami masih memverifikasi ketersediaannya dan akan segera menginformasikan kembali.';
}
