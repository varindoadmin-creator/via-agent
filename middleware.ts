...
const CRON_PATHS = ['/api/shipments/auto-invoice', '/api/customers/auto-repair', '/api/invoices-page/auto-send', '/api/inventory/price-lists/sync', '/api/salesperson-map/sync', '/api/salesorders/purchase-gap-check', '/api/shipments/aging-check'];
